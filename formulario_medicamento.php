...
<body>
	...
	?>
	<h1 style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#0000FF;"><span style="font-family:comic sans ms,cursive;"><strong>&nbsp;&nbsp;&nbsp;<u><em>&nbsp;&nbsp; Registro de Medicamentos</em></u></strong></span></span></h1>





	<form name="form1" method="get" action="insertar_registros_medicamento.php">
		<table align="center" border="3" cellpadding="1" cellspacing="1" style="width:500px;">
	<caption>Registro Medicamentos</caption>
			...
			<tr>
				<td>Codigo del Medicamento Formulacion:</td>
				<td><label for ="Formulacion_Cod_medicamento"></label>
				<input type="text" name="Formulacion_Cod_medicamento" id="Formulacion_Cod_medicamento"></td>
			</tr>

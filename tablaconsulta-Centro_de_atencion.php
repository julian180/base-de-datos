...
<center><table>
  ...
  $consulta = "SELECT * FROM Centro_de_atencion";
  ...
  {
    echo "<tr>";
    echo "<td>" . $columna['Nombre'] . "</td><td>" . $columna['Direccion'] . "</td>";
    echo "<td>" . $columna['Codigo_ciudad'] . "</td><td>" ;
    echo "</tr>";
  }

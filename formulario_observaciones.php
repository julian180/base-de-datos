...
<body>
	...
	?>
	<h1 style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#0000FF;"><span style="font-family:comic sans ms,cursive;"><strong>&nbsp;&nbsp;&nbsp;<u><em>&nbsp;&nbsp; Registro de Observaciones</em></u></strong></span></span></h1>





	<form name="form1" method="get" action="insertar_registros_observaciones.php">
		<table align="center" border="3" cellpadding="1" cellspacing="1" style="width:500px;">
	<caption>Registro de Observaciones</caption>

			<tr>
				<td>Motivo de la consulta:</td>
				<td><label for ="Motivo_consulta"></label>
				<input type="text" name="Motivo_consulta" id="Motivo_consulta"></td>
			</tr>

			<tr>
				<td>Diagnósitco:</td>
				<td><label for ="Diagnostico"></label>
				<input type="text" name="Diagnostico" id="Diagnostico"></td>
			</tr>

			<tr>
				<td>Código de la cita médica :</td>

...
<body>
	...
	<form name="form1" method="get" action="insertar_registros_pacientes.php">
		<table align="center" border="3" cellpadding="1" cellspacing="1" style="width:500px;">
	<caption>Datos Paciente</caption>
			...
			<tr>
				...
				<td><label for ="Nombre_paciente"></label>
				<input type="text" name="Nombre_paciente" id="Nombre_paciente"></td>
			</tr>
			...
			<tr>
				...
				<input type="text" name="Clasificacion" id="Clasificacion"></td>
			</tr>

...
<body>
  ...
  <!--================Header Menu Area =================-->
	...
	?>
	<h1 style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#0000FF;"><span style="font-family:comic sans ms,cursive;"><strong>&nbsp;&nbsp;&nbsp;<u><em>&nbsp;&nbsp; Registro de Citas Médicas</em></u></strong></span></span></h1>





	<form name="form1" method="get" action="insertar_registros_cita_medica.php">
		<table align="center" border="3" cellpadding="1" cellspacing="1" style="width:500px;">
	<caption>Registro Citas Médicas</caption>
			...
			<tr>
				<td>Nombre del Centro de Anteción:</td>
				<td><label for ="Centro_de_atencion_Nombre"></label>
				<input type="text" name="Centro_de_atencion_Nombre" id="Centro_de_atencion_Nombre"></td>
			</tr>

			<tr>
				<td>IDentificación del Medico:</td>
				<td><label for ="Medico_ID"></label>
				<input type="text" name="Medico_ID" id="Medico_ID"></td>
		 	</tr>

			<tr>
				<td>Código del Paciente:</td>
				<td><label for ="paciente_Cod"></label>
				<input type="text" name="paciente_Cod" id="paciente_Cod"></td>
			</tr>

			<tr>
				<td>Cödigo de especialidad:</td>
				<td><label for ="Especialidad_Codigo"></label>
				<input type="text" name="Especialidad_Codigo" id="Especialidad_Codigo"></td>
			</tr>

			<tr>
				<td>Facturación(Valor):</td>
				<td><label for ="Facturacion"></label>
				<input type="text" name="Facturacion" id="Facturacion"></td>
			</tr>

...
<center><table>
  ...
  $consulta = "SELECT * FROM Cita_medica";
  ...
  echo "<th>Telefono</th>";
  echo "<th>Fecha</th>";
  echo "<th>Centro_de_atencion_Nombre</th>";
  echo "<th>Medico_Id</th>";
  echo "<th>paciente_Cod</th>";
  echo "<th>Especialidad_Codigo</th>";
  echo "<th>Facturacion</th>";
  echo "</tr>";
  ...
  {
    echo "<tr>";
    echo "<td>" . $columna['Cod'] . "</td><td>" . $columna['Especialidad'] . "</td>";
    echo "<td>" . $columna['Telefono'] . "</td><td>" . $columna['Fecha'] . "</td>";
    echo "<td>" . $columna['Centro_de_atencion_Nombre'] . "</td><td>" . $columna['Medico_Id'] . "</td>";
    echo "<td>" . $columna['paciente_Cod'] . "</td><td>" . $columna['Especialidad_Codigo'] . "</td>";
    echo "<td>" . $columna['Facturacion'] . "</td><td>" ;
    echo "</tr>";
  }

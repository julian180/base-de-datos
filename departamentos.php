		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-left">
					<h2>Especialidades Centro Medico</h2>
					<div class="page_link">
	...
	<section class="procedure_category section_gap_custom">
		<div class="container">
			<div class="row justify-content-center section-title-wrap">
				<div class="col-lg-12">
					<h1>Especialidades Centro Medico</h1>
					<p>
						Mas Especialides que brindamos a nuestros pacientes:
					</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-4 mb-30">
					<div class="categories_post">
						<img src="img/procedure/neurologia.jpg" alt="Procedure">
				...
				<div class="col-lg-4 mb-30">
					<div class="categories_post">
						<img src="img/procedure/cardio.jpg" alt="Procedure">
						<div class="categories_details">
							<div class="categories_text">
								<div class="border_line"></div>
								<a href="single-blog.html">
				...
				<div class="col-lg-4 mb-30">
					<div class="categories_post">
						<img src="img/procedure/gastro.jpg" alt="Procedure">
						<div class="categories_details">
							<div class="categories_text">
								<div class="border_line"></div>
								<a href="single-blog.html">
				...
				<div class="col-lg-4">
					<div class="categories_post">
						<img src="img/procedure/ONCO1.jpg" alt="Procedure">
						<div class="categories_details">
							<div class="categories_text">
								<div class="border_line"></div>
								<a href="single-blog.html">
				...
				<div class="col-lg-4 mb-30">
					<div class="categories_post">
						<img src="img/procedure/ENCROCRI.jpg" alt="Procedure">
						<div class="categories_details">
							<div class="categories_text">
								<div class="border_line"></div>
								<a href="single-blog.html">
				...
				<div class="col-lg-4 mb-30">
					<div class="categories_post">
						<img src="img/procedure/OTORR.png" alt="Procedure">
						<div class="categories_details">
							<div class="categories_text">
								<div class="border_line"></div>
								<a href="single-blog.html">

...
<body>
	...
	?>
	<h1 style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#0000FF;"><span style="font-family:comic sans ms,cursive;"><strong>&nbsp;&nbsp;&nbsp;<u><em>&nbsp;&nbsp; Registro de Especialidad</em></u></strong></span></span></h1>





	<form name="form1" method="get" action="insertar_registros_especialidad.php">
		<table align="center" border="3" cellpadding="1" cellspacing="1" style="width:500px;">
	<caption>Registro Especialidad</caption>
			...
			<tr>
				<td>ID del Médico:</td>
				<td><label for ="id_medico"></label>
				<input type="text" name="id_medico" id="id_medico"></td>
			</tr>

			<tr>
				<td>Cödigo del paciente: </td>
				<td><label for ="Cod_paciente"></label>
				<input type="text" name="Cod_paciente" id="Cod_paciente"></td>
			</tr>

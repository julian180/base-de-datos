...
<body>
	...
	?>
	<h1 style="text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#0000FF;"><span style="font-family:comic sans ms,cursive;"><strong>&nbsp;&nbsp;&nbsp;<u><em>&nbsp;&nbsp; Registro de Ciudad</em></u></strong></span></span></h1>





	<form name="form1" method="get" action="insertar_registros_ciudad.php">
		<table align="center" border="3" cellpadding="1" cellspacing="1" style="width:500px;">
	<caption>Registro Ciudad</caption>

			<tr>
				<td>Código de Ciudad:</td>
				<td><label for ="Codigo_ciudad"></label>
				<input type="text" name="Codigo_ciudad" id="Codigo_ciudad"></td>
			</tr>
			...
			<tr>
				<td>Nombre del Centro de Atención:</td>

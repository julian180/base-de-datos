...
<body>
	...
	$num=$_GET["Numero"];//vairable donde se almacena  nombre cuadro de texto donde viene la información
	$raz=$_GET["Razon"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into remision(Numero,Razon,Especialidad_codigo,Medico_Id) VALUES ('$num','$raz','$esp','$med')";
	...
	if($resultados==false){
		...
		echo "<table><tr><td>Numero: $num</td></tr>";
		echo "<table><tr><td>Razon:  $raz</td></tr>";
		echo "<table><tr><td>Codigo de la especialidad : $esp</td></tr>";
				echo "<table><tr><td>Id del Medico : $med</td></tr>";

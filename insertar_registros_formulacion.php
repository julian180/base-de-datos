...
<body>
	...
	$dos=$_GET["Dosis"];//vairable donde se almacena  nombre cuadro de texto donde viene la información
	$cod=$_GET["Cod_medicamento"];
	$cit=$_GET["Cita_medica_Cod"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into formulacion(Dosis,Cod_medicamento,Cita_medica_Cod) VALUES ('$dos','$cod','$cit')";
	...
	if($resultados==false){
		...
		echo "<table><tr><td>Dosis: $dos</td></tr>";
		echo "<table><tr><td>Codigo del medicamento:  $cod</td></tr>";
		echo "<table><tr><td>Codigo de la cita medica : $cit</td></tr>";

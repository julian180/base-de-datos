...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into especialidad(Codigo,Nombre,id_medico,Cod_paciente) VALUES ('$cod','$nom','$id','$codp')";
	...
	if($resultados==false){
		...
		echo "<table><tr><td>Código de la especialidad: $cod</td></tr>";
		echo "<table><tr><td>Nombre de la Especialidad:  $nom</td></tr>";
		echo "<table><tr><td>ID del Médico : $id</td></tr>";
		echo "<table><tr><td>Codigo del paciente : $codp</td></tr>";

...
<body>
	...
	$cod=$_GET["Codigo_ciudad"];//vairable donde se almacena  nombre cuadro de texto donde viene la información
	$nom=$_GET["Nombre"];
	$cnom=$_GET["Centro_de_atencion_Nombre"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into ciudad(Codigo_ciudad,Nombre,Centro_de_atencion_Nombre) VALUES ('$cod', '$nom','$cnom')";
	...
	if($resultados==false){
		...
		echo "<table><tr><td>Código de la ciudad: $cod</td></tr>";
		echo "<table><tr><td>Nombre de la Ciudad:  $nom</td></tr>";
		echo "<table><tr><td>Nombre del Centro de Atención: $cnom</td></tr>";

...
<?php
    ...
    ?>
            ...
            <div class="main">
                <div class="title">
    <h2>Seleccione la tabla para agregar Registros  </h2>

    <li class="nav-item">
      <a class="nav-link" href="formulario_centro_de_atencion.php">Centro de Atención</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_cita_medica.php">Cita Médica</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_ciudad.php">Ciudad</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_especialidad.php">Especialidad</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_formulacion.php">Formulación</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_medicamento.php">Medicamento</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_medico.php">Médico</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_observaciones.php">Observaciones</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_registros_pacientes.php">Pacientes</a>
    </li>

    <li class="nav-item">
      <a class="nav-link" href="formulario_remision.php">Remisión</a>
    </li>

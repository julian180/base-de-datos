...
<body>
	...
	$mo=$_GET["Motivo_consulta"];//vairable donde se almacena  nombre cuadro de texto donde viene la información
	$dia=$_GET["Diagnostico"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into observaciones(Motivo_consulta,Diagnostico,Cita_medica_Cod) VALUES ('$mo','$dia','$cit')";
	...
	if($resultados==false){
		...
		echo "<table><tr><td>Motivo de la consulta: $mo</td></tr>";
		echo "<table><tr><td>Diagnostico:  $dia</td></tr>";

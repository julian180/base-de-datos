...
<?php
    ...
    <div class="main">
        <div class="title">
<h2>Seleccione la tabla para consultar </h2>

<li class="nav-item">
<a class="nav-link" href="tablaconsulta-Centro_de_atencion.php">Centro de Atención</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tablaconsulta-Cita_medica.php">Cita Médica</a>
</li>

<li class="nav-item">
<a class="nav-link" href="Tabla-ciudad.php">Ciudad</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tablaconsulta-Especialidad.php">Especialidad</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tabla-formulacion.php">Formulación</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tablaconsulta-Medicamento.php">Medicamento</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tablaconsulta-Medico.php">Médico</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tabla-observaciones.php">Observaciones</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tablaconsulta-paciente.php">Pacientes</a>
</li>

<li class="nav-item">
<a class="nav-link" href="tablaconsulta-Remision.php">Remisión</a>
</li>

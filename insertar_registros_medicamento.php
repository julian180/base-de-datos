...
<body>
	...
	$nom=$_GET["Nombre"];//vairable donde se almacena  nombre cuadro de texto donde viene la información
	$for=$_GET["Formulacion_Cod_medicamento"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into medicamento(Nombre,Formulacion_Cod_medicamento) VALUES ('$nom','$for')";
	...
	if($resultados==false){
		...
		echo "<table><tr><td>Formulacion_Cod_medicamento:  $for</td></tr>";

...
<body>
	...
	$id=$_GET["Id"];//vairable donde se almacena  nombre cuadro de texto donde viene la información
	$nom=$_GET["Nombre"];
	$dir=$_GET["Direccion"];
		$tel=$_GET["Telefono"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into medico(Id,Nombre,Direccion,Telefono) VALUES ('$id','$nom','$dir','$tel')";
	...
	if($resultados==false){
		...
		echo "Registros guradados correctamente <br> <br><br> <br><br><br><br>";
		echo "<table><tr><td>Id: $id</td></tr>";
		echo "<table><tr><td>Nombre:  $nom</td></tr>";
		echo "<table><tr><td>Direccion : $dir</td></tr>";
		echo "<table><tr><td>Telefono : $tel</td></tr><br><br><br><br><br><br>";

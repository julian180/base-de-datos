...
<body>
	...
	$tel=$_GET["Telefono"];
	$fecha=$_GET["Fecha"];
	$centro=$_GET["Centro_de_atencion_Nombre"];
		$med=$_GET["Medico_ID"];
			$pac=$_GET["paciente_Cod"];
				$esp=$_GET["Especialidad_Codigo"];
					$fac=$_GET["Facturacion"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into cita_medica(Cod,Especialidad,Telefono,Fecha,Centro_de_atencion_Nombre,Medico_ID,paciente_Cod,Especialidad_Codigo,Facturacion) VALUES ('$cod', '$esp','$tel','$fecha','$centro','$med','$pac','$esp','$fac')";
	...
	if($resultados==false){
		echo "Error al insertar datos, el código ya existe";
				...
				echo "Registros guradados correctamente <br><br><br><br><br><br>";
		echo "<table><tr><td>Código:$cod</td></tr>";
		echo "<table><tr><td>Especialidad $esp</td></tr>";
		echo "<table><tr><td>Telefono: $tel</td></tr>";
		echo "<table><tr><td>Fecha: $fecha</td></tr>";
		echo "<table><tr><td>Nombre Centro de Atencion: $centro</td></tr>";
		echo "<table><tr><td>ID Medico: $med</td></tr>";
		echo "<table><tr><td>Codigo del Paciente: $pac</td></tr>";
		echo "<table><tr><td>Codigo Especialidad: $esp</td></tr>";
		echo "<table><tr><td>Facturacion : $fac</td></tr>";
		}

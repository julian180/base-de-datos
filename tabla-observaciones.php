...
<BODY>
<H1>Base de datos Citas M�dicas</H1>
<P> TABLA Observaciones</P>
<center><table>
  <?PHP
  ...
  echo "<table borde='2'>";
  echo "<tr>";
  echo "<th>Motivo_consulta</th>";
  echo "<th>Diagnostico</th>";
  echo "<th>Cita_medica_cod</th>";
  echo "</tr>";
  // Bucle while que recorre cada registro y muestra cada campo en la tabla.
  while ($columna = mysqli_fetch_array( $resultado ))
  {
    echo "<tr>";
    echo "<td>" . $columna['Motivo_consulta'] . "</td><td>" . $columna['Diagnostico'] . "</td>";
    echo "<td>" . $columna['Cita_medica_cod'] . "</td><td>" ;
    echo "</tr>";
  }

  ...
  <!--================Header Menu Area =================-->
    ...
    <body>
       ...
       <a href="consultas.php">Pagina Principal</a>
                 <p style="text-align: right;"><a href="cierre.php">Cerrar sesión</a></p>
<?php
    ...
    <h2>Seleccione la Consulta  </h2>
                <br>
                <h2><a href="http://localhost/citas_medicas/busqueda_centros_de_atencion.php"> Centros de Antencion</a></h2>
                <br>
                <h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_asignatura.php"> Citas Medicas  </a></h2>
                <br>
                 <h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_laboratorio.php"> Ciudad  </a></h2>
                <br>
                <h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_software.php"> Especialidad  </a></h2>
                <br>
                <h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_asignacion.php">  Formulación  </a></h2>
                <br>
               <h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_asignacion.php">  Medicamento</a></h2>
                <br>
	<h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_asignacion.php">  Medico</a></h2>
                <br>
	<h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_asignacion.php">  Observaciones</a></h2>
                <br>
	<h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_asignacion.php">  Paciente</a></h2>
                <br>
	<h2><a href="http://localhost/ProyectoSalasdeSistemas/busqueda_asignacion.php">  Remision</a></h2>
                <br>
            </div>
        </div>
<br>

...
<body>
	...
	$nombre=$_GET["nombre"];//vairable donde se almacena  nombre cuadro de texto donde viene la información
	$dir=$_GET["Direccion"];
	$cod=$_GET["cod"];
...
// Para obtener registros de una tabla
	...
	$consulta="INSERT into centro_de_atencion(Nombre,Direccion,codigo_ciudad) VALUES ('$nombre','$dir','$cod')";
	...
	if($resultados==false){
		...
		echo "<table><tr><td>Código de Ciudad: $cod</td></tr>";
